...
# Crear una pagina web que permita al usuario: 
# reservar turnos en un restaurant
# mostrar el menu
# pedir delivery
# definir las tareas que seran necesarias, las vistas que se diseñaran y demas funcionalidades(login, tema oscuro,  etc.)
